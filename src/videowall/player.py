...
class Player(QWidget):
    ...
    def __init__(self, spec: typing.Optional[dict] = None):
        ...
        jog_button = make_button("⋘")
        jog_button.clicked.connect(lambda: self.jog(forward=False))
        self.bottom_row.addWidget(jog_button)
        ...
        jog_button = make_button("⋙")
        jog_button.clicked.connect(lambda: self.jog(forward=True))
        self.bottom_row.addWidget(jog_button)
        end_play_button = make_button("★")
